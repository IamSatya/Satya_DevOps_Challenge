...
echo "    DocumentRoot /var/www/html/" >> /etc/apache2/sites-available/$DOMAIN.conf
...
echo "  <meta http-equiv='refresh' content='0; URL=https://$DOMAIN/'>" >> /var/www/html/index.html
echo "</head>" >> /var/www/html/index.html
echo "</html>" >> /var/www/html/index.html

echo "RewriteEngine On" >> /var/www/html/.htaccess
echo "RewriteCond %\{SERVER_PORT} 80" >> /var/www/html/.htaccess
echo "RewriteRule ^(.*)$ https://$DOMAIN/$1 [R,L]" >> /var/www/html/.htaccess
